  ...
  render() {
    ...
    return (
      ...
      >
        <Layout.Section
          className={cx({
            'ice-my-layout-main-section': true,
            'ice-my-layout-main-section-open-drawer': this.state.openDrawer,
            'ice-my-layout-main-section-collapse': this.state.collapse,
          })}
        >
          ...
          >
            ...
            <Menu
              ...
              className="ice-my-layout-header-menu"
            >
              {asideNavs &&
                asideNavs.length > 0 &&
